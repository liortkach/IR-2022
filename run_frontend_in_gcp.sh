...
REGION=us-central1
ZONE=us-central1-c
PROJECT_NAME="ir-2022-370509"
IP_NAME="$PROJECT_NAME-ip"
GOOGLE_ACCOUNT_NAME="liortk" # without the @post.bgu.ac.il or @gmail.com part
...
http://104.198.155.47:8080/search?query=Lior+Tkach
################################################################################
